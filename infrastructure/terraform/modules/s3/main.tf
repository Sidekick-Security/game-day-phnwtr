...
# Version: ~> 5.0
# Purpose: Defines S3 bucket resources for GameDay Platform's object storage needs
...
# Main S3 bucket resource with proper naming convention and tags
  ...
  tags = merge(
    {
      ...
      ManagedBy   = "terraform"
      Purpose     = "gameday-platform-storage"
    },
    var.tags
  )
}
...
# Output the bucket details for reference
output "bucket_id" {
